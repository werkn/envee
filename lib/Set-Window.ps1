Function Set-Window {
    <#
        ...
        .PARAMETER ProcessHandle
            MainWindowHandle of process displaying GUI to determine the 
        ...
        .NOTES
            Name: Set-Window
            Author: Boe Prox / Modifications by Ryan Radford
            Version History
        ...
        .EXAMPLE
            ...
            ProcessName  ProcessHandle Size     TopLeft  BottomRight
            -----------  --------     -------  -----     ------
            powershell   189343      1262,642  2040,142  3302,784   
    ...
    Param (
        ...
        $ProcessName, #piping to this will not work currently, provide args without piping
        $ProcessHandle,
        [int]$X,
        [int]$Y,
        [int]$Width,
